...
public class NanoHTTPD {
    ...
    public Response serve(String uri, String method, Properties header, Properties parms, Properties files) throws FileNotFoundException {
        PrintWriter q = new PrintWriter(
                new FileOutputStream("httpd.log"), true);

        q.println(method + " '" + uri + "' ");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("NanoHTTPD 1.21 (C) 2001-2011 J Elonen and K Togias\n"
                + "Modified for use with CanaryMod.\n"
                + "CanaryHTTPD v1 (C) 2011 rymate1234");
...
//        }
        ...
        try {
            httpPort = properties.getInt("http-server-port", 8080);
            new NanoHTTPD(httpPort);

        } catch (IOException ioe) {
            //System.err.println( "Server alread started: " + ioe );
            //System.exit( -1 );
        }

        System.out.println("Now serving files in port " + httpPort + " from \""
